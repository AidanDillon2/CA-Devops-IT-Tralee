...
<h3>The web application is deployed on a docker container hosting latest Apache Tomcat web server image and static code check done via SonaarQube and sonarcloud. </h3>
