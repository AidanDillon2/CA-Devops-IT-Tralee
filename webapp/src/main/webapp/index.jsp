...
<h3>The web application form is deployed to docker container on Dockerhub and container is pull from dockerHub to a Tomcat web server container on docker host server (testing eamil) which hosts the web site.</h3>
